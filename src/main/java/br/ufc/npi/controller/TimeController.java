...
public class TimeController {
	...
	public ModelAndView adicionarJogadorAoTime(@PathVariable("idTime") Integer idTime, @RequestParam Integer jogadorSemTimeID){
	...
	public String removerTime(@PathVariable("id") Integer idTime){
